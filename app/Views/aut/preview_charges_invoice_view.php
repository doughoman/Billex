<div class="modal fade bill_charges_preview" id="invoice_preview" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered invoice_preview_modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="col-md-4">
                    <div class="type_select_option">
                        <select class="form-control selectpicker" data-width="100%" title="Choose one of the email invoice">
            ...
            <div class="modal-body invoice_table bill_charges_invoice" id="invoice_main_table">
                <?php
                foreach ($customer_data as $value) {
                    ...
                    ?>
                    <?php
                    if ($value['email_to_list'] == "") {
                        echo '<div class="position-relative">
                        <p class="bg_text_one">PREVIEW</p></div>';
                    } else {
                        echo '<div class="position-relative">
                        <p class="bg_text_one">PREVIEW</p>
                        <p class="bg_text_two">Will Email to</p>
                        <p class="bg_text_three">' . $value["email_to_list"] . '</p>
                    </div>';
                    }
                    ?>
                                            ...
                                            <table style="width:100%;" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="padding-bottom: 10px;">
                                                        ...
                                                        if (count($result) != 0) {
                                                            ?>
                                                            <a href="<?php echo base_url() . "pay/" . (encodeHashids(decrypt(base64_decode($value['customer_id'])))); ?>" class="make_paytment_link" style="float: right;color: #fff;background-color: #28a745;border-color: #28a745;text-decoration: underline;padding-left: 5px;padding-right: 5px;padding-top: 5px;padding-bottom: 5px;font-size: 13pt;border-radius: 4px;"><button class="make_paytment_link" style="border: none;background: no-repeat;text-decoration: underline;color: #fff !important;">Make Payment</button></a>
                                                            <?php
                                                        }
                                                        ?>
                                                    </td>
